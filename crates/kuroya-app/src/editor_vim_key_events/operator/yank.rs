...
pub(in crate::editor_vim_key_events) fn vim_yank_operator_motion(
...
pub(in crate::editor_vim_key_events) fn vim_yank_operator_motion_into_named_register(
    buffer: &mut TextBuffer,
    operator_count: usize,
    motion_count: usize,
    motion: EditorVimOperatorMotion,
...
pub(in crate::editor_vim_key_events) fn vim_yank_text_object(
    buffer: &mut TextBuffer,
    operator_count: usize,
    motion_count: usize,
...
pub(in crate::editor_vim_key_events) fn vim_yank_text_object_into_named_register(
    buffer: &mut TextBuffer,
    operator_count: usize,
    motion_count: usize,
    scope: EditorVimTextObjectScope,
