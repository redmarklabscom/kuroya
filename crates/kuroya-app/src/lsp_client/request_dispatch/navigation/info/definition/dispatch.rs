...
use super::pending::register_definition_request;
...
pub(super) async fn dispatch_definition(
    id: BufferId,
    path: PathBuf,
    version: u64,
    line: usize,
    ...
    let message = LspWireMessage::definition(request_id, &path, line, character).to_json();
