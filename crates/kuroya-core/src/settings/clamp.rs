use super::{
    ...
    MAX_EDITOR_SELECTION_HIGHLIGHT_MAX_LENGTH, MAX_EDITOR_STICKY_SCROLL_MAX_LINE_COUNT,
    MAX_EDITOR_STOP_RENDERING_LINE_AFTER, MAX_EDITOR_TAB_INDEX, MAX_EDITOR_WORD_WRAP_COLUMN,
    MAX_GIT_AUTOFETCH_PERIOD, MAX_GIT_DETECT_WORKTREES_LIMIT, MAX_GIT_INPUT_VALIDATION_LENGTH,
    ...
    MAX_QUICK_SUGGESTIONS_DELAY_MS, MAX_SCM_DIFF_DECORATIONS_GUTTER_WIDTH, MAX_SCM_GRAPH_PAGE_SIZE,
    MAX_SCM_INPUT_FONT_SIZE, MAX_SCM_INPUT_LINE_COUNT, MAX_SCM_REPOSITORIES_VISIBLE,
    MAX_SUGGEST_FONT_SIZE, MAX_SUGGEST_LINE_HEIGHT, MAX_TERMINAL_BELL_DURATION_MS,
    MAX_TERMINAL_CURSOR_WIDTH, MAX_TERMINAL_FONT_SIZE, MAX_TERMINAL_LETTER_SPACING,
    MAX_TERMINAL_LINE_HEIGHT, MAX_TERMINAL_MIN_COLUMNS, MAX_TERMINAL_MIN_ROWS,
    MAX_TERMINAL_MINIMUM_CONTRAST_RATIO, MAX_TERMINAL_SCROLL_SENSITIVITY,
    MAX_TERMINAL_SCROLLBACK_ROWS, MAX_WINDOW_ZOOM_LEVEL, MIN_AUTOSAVE_DELAY_MS,
    MIN_DIFF_RENDER_SIDE_BY_SIDE_INLINE_BREAKPOINT, MIN_DIFF_SPLIT_VIEW_DEFAULT_RATIO,
    MIN_EDITOR_ACCESSIBILITY_PAGE_SIZE, MIN_EDITOR_CODE_LENS_FONT_SIZE,
    MIN_EDITOR_COLOR_DECORATORS_LIMIT, MIN_EDITOR_CURSOR_HEIGHT, MIN_EDITOR_CURSOR_WIDTH,
    MIN_EDITOR_FOLDING_MAXIMUM_REGIONS, MIN_EDITOR_FONT_SIZE, MIN_EDITOR_INLAY_HINTS_FONT_SIZE,
    ...
    MIN_GIT_AUTOFETCH_PERIOD, MIN_GIT_DETECT_WORKTREES_LIMIT, MIN_GIT_INPUT_VALIDATION_LENGTH,
    ...
    MIN_QUICK_SUGGESTIONS_DELAY_MS, MIN_SCM_DIFF_DECORATIONS_GUTTER_WIDTH, MIN_SCM_GRAPH_PAGE_SIZE,
    MIN_SCM_INPUT_FONT_SIZE, MIN_SCM_INPUT_LINE_COUNT, MIN_SCM_REPOSITORIES_VISIBLE,
    MIN_SUGGEST_FONT_SIZE, MIN_SUGGEST_LINE_HEIGHT, MIN_TERMINAL_BELL_DURATION_MS,
    MIN_TERMINAL_CURSOR_WIDTH, MIN_TERMINAL_FONT_SIZE, MIN_TERMINAL_LETTER_SPACING,
    MIN_TERMINAL_LINE_HEIGHT, MIN_TERMINAL_MIN_COLUMNS, MIN_TERMINAL_MIN_ROWS,
    MIN_TERMINAL_MINIMUM_CONTRAST_RATIO, MIN_TERMINAL_SCROLL_SENSITIVITY,
    MIN_TERMINAL_SCROLLBACK_ROWS, MIN_WINDOW_ZOOM_LEVEL,
};
...
pub fn clamp_occurrences_highlight_delay_ms(delay_ms: usize) -> usize {
    delay_ms.clamp(
...
pub fn clamp_editor_selection_highlight_max_length(length: usize) -> usize {
    length.clamp(
