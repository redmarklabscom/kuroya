...
impl ThemeSettings {
    pub fn built_in_presets() -> Vec<Self> {
        vec![
            ...
            Self {
                name: "Sakura Milk".to_owned(),
                background: [255, 246, 250],
                panel: [248, 230, 239],
                panel_alt: [239, 213, 226],
                text: [58, 45, 55],
                muted_text: [118, 90, 105],
                accent: [204, 73, 128],
                selection: Some([247, 194, 214]),
                warning: [164, 103, 40],
                error: [196, 72, 87],
            },
            Self {
                name: "Mochi Mint".to_owned(),
                background: [242, 251, 248],
                panel: [225, 244, 240],
                panel_alt: [206, 232, 229],
                text: [35, 53, 54],
                muted_text: [82, 115, 113],
                accent: [37, 143, 132],
                selection: Some([185, 226, 218]),
                warning: [170, 111, 35],
                error: [190, 62, 82],
            },
            Self {
                name: "Sky Ribbon".to_owned(),
                background: [242, 248, 255],
                panel: [225, 238, 250],
                panel_alt: [207, 225, 242],
                text: [35, 48, 62],
                muted_text: [82, 102, 124],
                accent: [65, 121, 211],
                selection: Some([188, 217, 249]),
                warning: [173, 116, 36],
                error: [191, 64, 93],
            },
            Self {
                name: "Starry Idol".to_owned(),
                background: [19, 18, 34],
                panel: [28, 26, 48],
                panel_alt: [41, 37, 67],
                text: [239, 235, 255],
                muted_text: [159, 150, 187],
                accent: [255, 142, 194],
                selection: Some([83, 61, 114]),
                warning: [244, 190, 96],
                error: [255, 111, 136],
            },
            Self {
                name: "Peach Festival".to_owned(),
                background: [31, 22, 28],
                panel: [44, 31, 39],
                panel_alt: [59, 41, 50],
                text: [247, 232, 226],
                muted_text: [184, 139, 141],
                accent: [255, 159, 116],
                selection: Some([93, 58, 64]),
                warning: [245, 187, 83],
                error: [246, 100, 113],
            },
        ]
